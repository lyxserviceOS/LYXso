...
export default async function KjoretoyPage() {
  ...
  if (!user) {
    redirect('/login?redirect=/min-side/kjoretoy');
  }
  ...
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_API_URL}/api/customers/${customer.id}/vehicles`,
    {
      headers: {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-bold mb-8">Mine Kjøretøy</h1>
